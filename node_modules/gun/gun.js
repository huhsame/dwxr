...
// for update
// bridge.emitConnection [wire.js] ----socket:data(user:pid) to clients ---> wire.onmessage [gun.js] ----data---> bridge(gun.js) ----event: onuser---> experiments.js
let bridge = function(){};
		...
		function Mesh(root){
			...
			mesh.hi = function(peer){
				...
				if(peer.id){
					...
					console.log('gun server peers: ' + Object.keys(opt.peers));
				} else {
