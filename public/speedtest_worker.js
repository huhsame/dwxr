...
var settings = {
    ...
    url_dl: "speed/garbage", // path to a large file or garbage.php, used for download test. must be relative to this js file
    url_ul: "speed/empty", // path to an empty file, used for upload test. must be relative to this js file
    url_ping: "speed/empty", // path to an empty file, used for ping test. must be relative to this js file
    url_getIp: "speed/getIP", // path to getIP.php relative to this js file, or a similar thing that outputs the client's ip
    ...
    url_telemetry: "api/speedLog/create", // path to the script that adds telemetry data to the database
...
function sendTelemetry(done) {
    ...
    try {
        ...
        speed.dl = dlStatus;
        speed.ul = ulStatus;
        speed.ping = pingStatus;
        speed.jitter = jitterStatus;

        let json = JSON.stringify({isp: telemetryIspInfo.rawIspInfo, speed});
